...
import de.fhpotsdam.unfolding.marker.SimplePointMarker;
	 ...
	 */
	public class Mapas extends SimplePointMarker {
		 ...
		 */
		public Mapas(Location location) {
			this(location, null, null, 0);
		}

		public Mapas(Location location, String name) {
			this(location, name, null, 0);
		}

		public Mapas(Location location, String name, PFont font, float size) {
